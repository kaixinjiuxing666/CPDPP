...
class CUHKPEDES_BERT_token(data.Dataset):
    ...
    def __init__(self, root, split, max_length, transform=None, target_transform=None,
        ...
        if self.split == 'train':
            ...
            with open(os.path.join("/home/xs/Documents/codes/TIPCB-00/data", self.pklname), 'rb') as f_pkl:
            ...
            #---------------- generate all test data image dict, like: "0":"image path" 
            # save_path = r'/home/xs/Documents/codes/TIPCB-00/data/img_rank/test_img_index_path_dict_3074.npz'
            # test_dict = {}
            # # gallery_label = self.test_labels[::2]
            # gallery_feature_ = self.test_images[::2]
            # for n,i in enumerate(gallery_feature_):
            #     x = os.path.join(self.root, 'CUHK-PEDES/imgs/'+i)
            #     test_dict[str(n)] = x
            ...
            # save_path = r'/home/xs/Documents/codes/TIPCB-00/data/img_rank/test_img_index_path_dict_6148.npz'
            # test_dict = {}
            # # gallery_label = self.test_labels[::2]
            # gallery_feature_ = self.test_images
            # for n,i in enumerate(gallery_feature_):
            #     x = os.path.join(self.root, 'CUHK-PEDES/imgs/'+i)
            #     test_dict[str(n)] = x
            # with open(save_path, 'wb') as f:
