...
def parse_args():
    ...
    # parser.add_argument('--name', default='7_tipcb_pcb_80_danet_position', type=str, help='output model name')
    ...
    #adam_setting
    # parser.add_argument('--adam_lr', type=float, default=0.006, help='the learning rate of adam')
    ...
    parser.add_argument('--epoches_decay', type=str, default='55_75', help='#epoches when learning rate decays')
    parser.add_argument('--warm_epoch', default=20, type=int, help='the first K epoch that needs warm up')
